...
const menuData = {
  it: {
    cena: [
      { name: "TAGLIERE MISTO", price: "16 €", desc: "Salumi e formaggi toscani, marmellata fatta in casa e polpette di carne con sugo al pomodoro. Servito con schiacciata alla pala e pane toscano." },
      { name: "TAGLIERE VEGETARIANO", price: "15 €", desc: "Formaggi misti, e marmellata fatta in casa, hummus con carotine, polentine croccanti ai funghi e polpette vegetariane con salsa del giorno." },
      { name: "PANINO DI PULLED PORK", price: "12 €", desc: "Con cipolla di Certaldo caramellata e cetriolini. Servito con contorno di patatine fritte." },
      { name: "PIZZA HAMBURGER", price: "12 €", desc: "Con rigatino croccante e cheddar fuso. Servito con contorno di patatine fritte." },
      { name: "BURGER DI FALAFEL", price: "12 €", desc: "Con insalata di cavolo viola e yogurt alla menta. Servito con contorno di patatine fritte." },
      { name: "FRITTO MISTO LAMI", price: "10 €", desc: "Anelli di cipolla, verdure in pastella, mozzarelline in carrozza e frittelle di pasta lievitata con alghe di mare. Servite con maionese al lime." },
      { name: "COSTINE SENAPE E MIELE", price: "12 €", desc: "Costine saporite glassate alla senape e miele." },
      { name: "DOLCE DEL GIORNO", price: "5 €", desc: "La nostra selezione dolce artigianale del giorno." }
    ],
    bevuta: [
      { name: "MAIALA BOCCIO", price: "9 €", desc: "Bickens London Dry Gin, Bitter Campari, Vermouth Rosso Cinzano e Brancamenta." },
      { name: "FAKE MARY", price: "9 €", desc: "Base a scelta tra Vodka Sky o Sotol Flor del Desierto, sale, pepe nero, sedano, pomodoro, brodo di carne, paprika e peperoncino. Chiarificato." },
      { name: "DEEP PURPLE", price: "9 €", desc: "Gin tonic dal colore violaceo con Bickens London Dry Gin infuso al Butterfly Pea Tea e Indian Tonic J.Gasco." },
      { name: "WILLY GOES TO SCOTLAND", price: "9 €", desc: "Ballantine's Blended Scotch Whisky, shrub di pere Williams e bitter al cioccolato. Nebulizzazione di Laphroaig 10 years." },
      { name: "FRENCH 26", price: "9 €", desc: "Bickens London Dry Gin, Acqua di Cedro Nardini, succo di limone e spumante brut." },
      { name: "PORNSTAR", price: "9 €", desc: "Vodka Sky infusa al passion fruit, Frangelico, sciroppo di zucchero e spumante brut servito a parte." },
      { name: "DRY MARTINI", price: "7 €", desc: "Bickens London Dry Gin e Vermouth Bianco Dry Cinzano." },
      { name: "PALOMA", price: "7 €", desc: "Tequila Blanco Espolón, succo di lime, sciroppo d'Agave Papa Borracho, soda al pompelmo rosa J.Gasco." },
      { name: "SPRITZ MEDITERRANEO", price: "7 €", desc: "Aperitivo Venturo, spumante brut e soda. Basso contenuto alcolico." },
      { name: "SPRITZ ROSA", price: "7 €", desc: "Sarti rosa all'arancia sanguinella, mango e passion fruit, spumante brut e soda." }
    ]
  },
  en: {
    cena: [
      { name: "MIXED TUSCAN PLATTER", price: "16 €", desc: "Tuscan cold cuts and cheeses, homemade jam, and meatballs in tomato sauce. Served with artisanal flatbread and local Tuscan bread." },
      { name: "VEGETARIAN PLATTER", price: "15 €", desc: "Mixed artisanal cheeses, homemade jam, hummus with carrots, crispy mushroom polenta bites, and vegetarian meatballs with sauce of the day." },
      { name: "PULLED PORK SANDWICH", price: "12 €", desc: "Slow-cooked pulled pork featuring caramelized Certaldo onions and pickles. Accompanied by a side of crispy french fries." },
      { name: "PIZZA BURGER", price: "12 €", desc: "Juicy burger topped with crispy local 'rigatino' bacon and melted cheddar cheese. Served with a side of french fries." },
      { name: "FALAFEL BURGER", price: "12 €", desc: "Crispy house falafel patty topped with purple cabbage slaw and fresh mint yogurt sauce. Served with french fries." },
      { name: "LAMI CRISPY FRY BASKET", price: "10 €", desc: "Golden onion rings, batter-fried garden vegetables, mini mozzarella bites, and traditional leavened seaweed fritters. Served with fresh lime mayo." },
      { name: "HONEY MUSTARD RIBS", price: "12 €", desc: "Tender, savory pork ribs heavily glazed in a rich honey mustard reductions." },
      { name: "DESSERT OF THE DAY", price: "5 €", desc: "Ask our staff for today's freshly prepared, artisanal sweet selection." }
    ],
    bevuta: [
      { name: "MAIALA BOCCIO", price: "9 €", desc: "Bickens London Dry Gin, Bitter Campari, Vermouth Rosso Cinzano, and explicit minty notes of Brancamenta." },
      { name: "FAKE MARY", price: "9 €", desc: "Your choice of Skyy Vodka or Sotol Flor del Desierto, salt, black pepper, celery, tomato, rich meat broth, paprika, and chili. Beautifully clarified." },
      { name: "DEEP PURPLE", price: "9 €", desc: "Vibrant violet-tinted Gin Tonic mixing Bickens London Dry Gin infused with Butterfly Pea Tea and Indian Tonic by J.Gasco." },
      { name: "WILLY GOES TO SCOTLAND", price: "9 €", desc: "Ballantine's Blended Scotch Whisky, sweet Williams pear shrub, and dark chocolate bitters. Finished with a heavy mist of Laphroaig 10 Year." },
      { name: "FRENCH 26", price: "9 €", desc: "Bickens London Dry Gin, Nardini Citron Water, freshly squeezed lemon juice, and elegant sparkling brut sparkling wine." },
      { name: "PORNSTAR COCKTAIL", price: "9 €", desc: "Passion fruit-infused Skyy Vodka, nutty Frangelico liqueur, simple syrup, served with a side shot of sparkling brut." },
      { name: "DRY MARTINI", price: "7 €", desc: "Classic execution of Bickens London Dry Gin and elegant Cinzano Dry White Vermouth." },
      { name: "PALOMA", price: "7 €", desc: "Espolón Blanco Tequila, fresh lime juice, artisanal Papa Borracho Agave syrup, finished with J.Gasco pink grapefruit soda." },
      { name: "MEDITERRANEAN SPRITZ", price: "7 €", desc: "Venturo Aperitivo, sparkling brut, and clean soda. Premium low-alcohol choice." },
      { name: "PINK SPRITZ", price: "7 €", desc: "Sarti Rosa liqueur yielding vibrant blood orange, mango, and passion fruit notes, built with prosecco brut and soda." }
    ]
  }
};
