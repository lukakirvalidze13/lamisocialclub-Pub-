...
const menuData = {
  it: {
    cena: [
      ...
      { name: "TAGLIERE VEGETARIANO", price: "15 €", img: "https://static.tecnichenuove.it/cucinanaturale/2022/07/tagliere-greco-antipasto.jpg", desc: "Formaggi misti, e marmellata fatta in casa, hummus con carotine, polentine croccanti ai funghi e polpette vegetariane con salsa del giorno." },
      { name: "PANINO DI PULLED PORK", price: "12 €", img: "https://blog.giallozafferano.it/delizieinpentola/wp-content/uploads/2022/03/Panino-con-sfilaccetti-di-maiale-scaled.jpg", desc: "Con cipolla di Certaldo caramellata e cetriolini. Servito con contorno di patatine fritte." },
      { name: "PIZZA HAMBURGER", price: "12 €", img: "https://www.allrecipes.com/thmb/wpSERQDnnTjo9u89Sf9tzkfnxw4=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/231771true-cheeseburger-pizzafabeveryday4x3-aa3f0174b8714180a73190cb64919bd1.jpg", desc: "Con rigatino croccante e cheddar fuso. Servito con contorno di patatine fritte." },
      { name: "BURGER DI FALAFEL", price: "12 €", img: "https://assets.biggreenegg.eu/app/uploads/2021/03/05090934/topimage-vega-falafelburger-2021m03-800x533-1.jpg", desc: "Con insalata di cavolo viola e yogurt alla menta. Servito con contorno di patatine fritte." },
      { name: "FRITTO MISTO LAMI", price: "10 €", img: "https://www.unafamigliaincucina.com/wp-content/uploads/2023/07/IMG_0989-500x500.jpg", desc: "Anelli di cipolla, verdure in pastella, mozzarelline in carrozza e frittelle di pasta lievitata con alghe di mare. Servite con maionese al lime." },
      { name: "COSTINE SENAPE E MIELE", price: "12 €", img: "https://media-assets.lacucinaitaliana.it/photos/6928869aa407c4cfe7ff2b6d/master/w_1600%2Cc_limit/Costine%2520di%2520maiale%2520glassate%2520alla%2520senape%2520e%2520miele%2520con%2520champignon%2520e%2520cavolfiore.jpg", desc: "Costine saporite glassate alla senape e miele." },
      { name: "DOLCE DEL GIORNO", price: "5 €", img: "https://www.cucchiaio.it/content/dam/cucchiaio/it/ricette/2013/05/ricetta-budino-riso/budino-riso-finale.jpg", desc: "La nostra selezione dolce artigianale del giorno." }
    ],
    bevuta: [
  ...
  en: {
    cena: [
 { 
    name: "MIXED TUSCAN PLATTER", 
    price: "16 €", 
    img: "https://www.fattoincasadabenedetta.it/wp-content/uploads/2022/12/IDEA_DI_TAGLIERE_DI_SALUMI_E_FORMAGGI_PER_MILLE_OCCASIONI_SITO-9.jpg", 
    desc: "Tuscan cold cuts and cheeses, homemade jam, and meatballs in tomato sauce. Served with flatbread and local Tuscan bread." 
  },
  { 
    name: "VEGETARIAN PLATTER", 
    price: "15 €", 
    img: "https://static.tecnichenuove.it/cucinanaturale/2022/07/tagliere-greco-antipasto.jpg", 
    desc: "Mixed artisanal cheeses, homemade jam, hummus with carrots, crispy mushroom polenta bites, and vegetarian meatballs with sauce of the day." 
  },
  { 
    name: "PULLED PORK SANDWICH", 
    price: "12 €", 
    img: "https://blog.giallozafferano.it/delizieinpentola/wp-content/uploads/2022/03/Panino-con-sfilaccetti-di-maiale-scaled.jpg", 
    desc: "Slow-cooked pulled pork featuring caramelized Certaldo onions and pickles. Accompanied by a side of crispy french fries." 
  },
  { 
    name: "PIZZA BURGER", 
    price: "12 €", 
    img: "https://www.allrecipes.com/thmb/wpSERQDnnTjo9u89Sf9tzkfnxw4=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/231771true-cheeseburger-pizzafabeveryday4x3-aa3f0174b8714180a73190cb64919bd1.jpg", 
    desc: "Juicy burger topped with crispy local 'rigatino' bacon and melted cheddar cheese. Served with a side of french fries." 
  },
  { 
    name: "FALAFEL BURGER", 
    price: "12 €", 
    img: "https://assets.biggreenegg.eu/app/uploads/2021/03/05090934/topimage-vega-falafelburger-2021m03-800x533-1.jpg", 
    desc: "Crispy house falafel patty topped with purple cabbage slaw and fresh mint yogurt sauce. Served with french fries." 
  },
  { 
    name: "LAMI CRISPY FRY BASKET", 
    price: "10 €", 
    img: "https://www.unafamigliaincucina.com/wp-content/uploads/2023/07/IMG_0989-500x500.jpg", 
    desc: "Golden onion rings, batter-fried garden vegetables, mini mozzarella bites, and traditional leavened seaweed fritters. Served with fresh lime mayo." 
  },
  { 
    name: "HONEY MUSTARD RIBS", 
    price: "12 €", 
  ...
  { 
    ...
    price: "5 €", 
    img: "https://www.cucchiaio.it/content/dam/cucchiaio/it/ricette/2013/05/ricetta-budino-riso/budino-riso-finale.jpg", 
    desc: "Ask our staff for today's freshly prepared, artisanal sweet selection." 
  }
],
    bevuta: [
